                                ...
                                <table class="table container-fluid ">
                                  <thead class="thead-dark ">
                                    <tr>
                                      ...
                                      <th scope="col">訊息content</th>
                                      <th scope="col">時間add_date</th> 
                                    </tr>
                                  </thead>
...
<?php
											...
											$sql = "SELECT cardnum, postive, PayValue, date_time as 'day' FROM `icer_pay` i WHERE 1 {$sql_kw} ORDER BY date_time DESC";	
