...
$sql = "SELECT number FROM `seat` WHERE id in ({$sql_in})";
...
<section id="main" class="wrapper">
	...
	<div class="inner">
		<div class="row">
			<div class="col-12">
				<form id='mform' action="schedule_all_update.php" method="post" accept-charset="utf-8">
					<table class="table">
						<tr>
					...
					<input type='hidden' name='sid_all' value='<?php echo $sql_in ?>'>
				</form>
			</div>
		</div>
	</div>
