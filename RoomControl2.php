...
<section id="main" class="wrapper">
	...
	<h2 style="margin-top: -30px;" align="center">收費模式設定</h2>
	<div class="col-12"><a href='normal_administration.php'><i class='fas fa-chevron-circle-left fa-3x'></i></a></div>
	
	<!-- <div class="container" style="text-align: left;">
           <p>
            <a href="member_new_users.php" class="btn btn-success my-2"><?php echo $lang->line("index.create_member");?></a>	 
             <a href="member_card_new.php" class="btn btn-success my-2"><?php echo $lang->line("index.new_public_idcard"); ?></a> 
                ...
                <?php if( ($_SESSION[admin_user][id] == '余惠真') || ($_SESSION[admin_user][id] == 'andy') || ($_SESSION[admin_user][id] == 'aoadmin') ){ ?>
					...
					<div class="col-4">
						...
						<div class="form-check">
							...
							<input type="radio" class="BoxMode form-check-input userroomBoxChangeMode" name="status" value="update_mode" id="exampleCheck3" checked>
			...
			<div class="row">
			 ...
			 <div class="col-6">	 
                <form style="width: 55%; text-align: center; margin: 0 auto;" action="RoomControlUpd.php" method="post">
                    ...
                    <input type="hidden" class="BoxValueStatus" name="status">
